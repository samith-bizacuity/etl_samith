...
def main():
    ...
    table = 'EMPLOYEES'
    query_update_1 = queries[table][0]
    query_insert = queries[table][1]
    query_update_2 = queries[table][2]
    ...
    try:
        ...
        cursor.execute(query_update_1, (etl_batch_no, etl_batch_date))
        redshift_conn.commit()
        cursor.execute(query_insert, (etl_batch_no, etl_batch_date))
        redshift_conn.commit()
        cursor.execute(query_update_2, (etl_batch_no, etl_batch_date))
        redshift_conn.commit()
